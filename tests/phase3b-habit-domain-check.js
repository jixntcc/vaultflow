...
// Use a date relative to the execution day so this domain test does not become
// stale as calendar time advances.
const tomorrowDate = new Date(`${D.getTodayLocalDate()}T12:00:00`);
tomorrowDate.setDate(tomorrowDate.getDate() + 1);
const tomorrow = tomorrowDate.toISOString().slice(0, 10);
const pending = D.getHabitStatus('h1', tomorrow);
